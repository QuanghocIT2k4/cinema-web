    ...
    return (
      <div className="bg-[#1a2232] rounded-lg p-8 shadow-lg text-center">
        ...
        <p className="text-gray-400 mb-4">
          {error && typeof error === 'object' && 'message' in (error as any) ? (error as any).message : 'Please try again later.'}
        </p>
        <button
    ...
    <div className="space-y-6">
      <div className="bg-[#1a2232] rounded-lg p-6 shadow-lg flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 text-sm">Showing {movies.length} / {totalElements} movies</p>
        </div>
      </div>
      ...
      {movies.length > 0 ? (
        ...
        <div className="bg-[#1a2232] rounded-lg p-12 shadow-lg text-center">
          ...
          <p className="text-gray-400">Try adjusting the filters to find other movies.</p>
        </div>
      )}
    </div>
  )
